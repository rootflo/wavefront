...
export class VoiceAgentService {
  ...
  async createVoiceAgent(
    data: CreateVoiceAgentRequest
  ): Promise<VoiceAgentResponse> {
    const response: IApiResponse<VoiceAgentData> = await this.http.post(
      `/v1/:appId/floware/v1/voice-agents`,
      data
    );
    return response;
  }
  ...
  async getVoiceAgent(agentId: string): Promise<VoiceAgentDetailResponse> {
    const response: IApiResponse<VoiceAgent> = await this.http.get(
  ...
  async listAllVoiceAgents(): Promise<VoiceAgentListResponse> {
    const response: IApiResponse<VoiceAgentListData> = await this.http.get(
      `/v1/:appId/floware/v1/voice-agents`
    );
    return response;
  }
  ...
  async initiateCall(
    ...
    const response = await this.http.post(
      `/v1/:appId/floware/v1/voice-agents/${agentId}/initiate`,
      data
    );
    return response;
  }
