...
const getDatasourceKey = (appId: string, datasourceId: string) => [
  "datasource",
  appId,
  datasourceId,
];
const getAllYamlsKey = (appId: string, datasourceId: string) => [
  "yamls",
  appId,
  datasourceId,
];
const readYamlKey = (appId: string, datasourceId: string, yamlId: string) => [
  "yaml",
  appId,
  datasourceId,
  yamlId,
...
const getAuthenticatorKey = (appId: string, authId: string) => [
  "authenticator",
  appId,
  authId,
];
const getLLMConfigsKey = (appId: string) => ["llm-configs", appId];
const getLLMConfigKey = (appId: string, configId: string) => [
  "llm-config",
  appId,
  configId,
];
const getModelsKey = (appId: string) => ["models", appId];
const getModelKey = (appId: string, modelId: string) => [
  "model",
  appId,
  modelId,
];
const getKnowledgeBasesKey = (appId: string) => ["knowledge-bases", appId];
const getKnowledgeBaseKey = (appId: string, kbId: string) => [
  "knowledge-base",
  appId,
  kbId,
];
const getKnowledgeBaseDocumentsKey = (appId: string, kbId: string) => [
  "knowledge-base-documents",
  appId,
  kbId,
];
const getKnowledgeBaseInferencesKey = (appId: string, kbId: string) => [
...
const getWorkflowPipelinesKey = (appId: string) => [
  "workflow-pipelines",
  appId,
];
const getWorkflowRunsKey = (
  appId: string,
...
const getVoiceAgentKey = (appId: string, agentId: string) => [
  "voice-agent",
  appId,
  agentId,
];
const getTtsConfigKey = (appId: string, configId: string) => [
  "tts-config",
  appId,
  configId,
];
const getSttConfigKey = (appId: string, configId: string) => [
  "stt-config",
  appId,
  configId,
];
const getTelephonyConfigKey = (appId: string, configId: string) => [
  "telephony-config",
  appId,
  configId,
];
const getAgentKey = (appId: string, agentId: string) => [
  "agent",
  appId,
  agentId,
];
const getToolsKey = (appId: string) => ["tools", appId];
const getApiServiceKey = (appId: string, serviceId: string) => [
  "api-service",
  appId,
  serviceId,
];
const getMessageProcessorsKey = (appId: string) => [
  "message-processors",
  appId,
];
const getMessageProcessorKey = (appId: string, processorId: string) => [
  "message-processor",
  appId,
  processorId,
];
...
const getPipelineKey = (appId: string, pipelineId: string) => [
  "pipeline",
  appId,
  pipelineId,
];
const getPipelineFilesKey = (appId: string, pipelineId: string) => [
  "pipeline-files",
  appId,
  pipelineId,
];
