...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="animate-fade-in flex h-full w-full flex-col items-center gap-[60px] overflow-y-auto bg-[url('/background.webp')] bg-cover bg-center px-[152px] pb-10 pt-[64px]">
      <div className="flex flex-col items-center justify-center gap-5">
        <div className="flex w-[626px] items-center justify-center text-center">
          <p className="text-[40px] font-semibold text-[#101010]">
            Welcome to Rootflo's App Management Dashboard
          </p>
        </div>
        <p className="text-[20px] font-normal text-[#404040]">
